...
<body>
    ...
    <table width="750px" class="body" bgcolor="#f7f7f7" cellpadding="0" cellspacing="0"
        style="width:100%;background:#f7f7f7;margin:0;padding:0 20px;">
        <tr>
            <td style="padding: 0px 0 0;">
                <table bgcolor="#ffffff" class="m-width" width="740px" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td bgcolor="#E8E5DE" valign="top" style="padding-top: 30px; padding-bottom:30px">
                            <a target="_blank" href="javascript:;"
                                style="margin-left:auto;margin-right:auto;text-align:center;">
                                <img alt="image" src="{{ asset('img/logo.png') }}" width="100"
                                    style="max-width:170px;width: 100%;padding: 0; border: 0;display:block;margin:0 auto;"
                                    border="0">
                            </a>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <table cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td colspan="3" style="padding: 0  80px;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td align="left" valign="top"
                                                        style="width: 100%;font-size: 16px; line-height: 26px;color: #777777;">
                                                        @yield('image')
                                                        <h2
                                                            style="    color: #1B1B1B;font-weight: 700;padding-bottom: 0px;font-size: 26px;padding-top: 5px;">
                                                            @yield('title')</h2>
                                                        <h5
                                                            style="    font-size: 20px;color: #1B1B1B;letter-spacing: -0.005em;margin: 0;margin-bottom: 10px;font-weight: 600;">
                                                            @yield('greet')</h5>
                                                        <p
                                                            style="    font-size:16px;color: #1B1B1B;letter-spacing: -0.005em;">
                                                            @yield('message')</p>
                                                    </td>
                                                    <td></td>
                                                </tr>
