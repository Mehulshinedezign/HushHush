            ...
            <div class="cust-nav-header-sec">
                ...
                <div class="collapse navbar-collapse cust-navbar-header" id="navbarNav">
                    <div class="header-cart">
                        <ul>
                            <li>
                                {{-- <img src="{{ asset('front/images/clothes-d.png') }}" class="lend-cloth"> --}}
                                <p class="open-product-popup d-none d-lg-block">Lend Your Closet </p>
                            </li>
                            @auth
                                {{-- <li><a href="#"><i class="fa-solid fa-cart-shopping"></i></a></li> --}}
                                {{-- <li><a href="#" class="notification"><i class="fa-regular fa-bell"></i></a></li> --}}
                                ...
                                @auth
                                    <div class="user-profile-dropdown">
                                        <ul>
                                            ...
                                            {{-- <li><a href="{{ route('orderchat') }}"><i
                                                        class="fa-regular fa-comments"></i>Messages</a></li> --}}

                                            {{-- <li><a href="{{ route('payment-history') }}"><i class="fa-regular fa-credit-card"></i>Payment History</a></li> --}}
