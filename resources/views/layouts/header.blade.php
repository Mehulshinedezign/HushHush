                        ...
                        <li>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton1">
                                  ...
                                  <li><a class="dropdown-item" href="#"><img src="{{asset('front/images/user-icon.svg')}}" alt="img">Profile</a></li>
                                  <li><a class="dropdown-item" href="#"><img src="{{asset('front/images/order-history-icon.svg')}}" alt="img">Order History</a></li>
                                  <li><a class="dropdown-item" href="#"><img src="{{asset('front/images/rent-req-icon.svg')}}" alt="img">Rental Request</a></li>
