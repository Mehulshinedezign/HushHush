        ...
        rangeInputValue.forEach((range, index) => {
            range.addEventListener("input", (e) => {
                ...
                if (maxVal - minVal < priceGap) {
                    ...
                    document.getElementById('styleForSlider').value = `left:${(minVal / rangeInputValue[0].max) * 100}%; right:${100 - (maxVal / rangeInputValue[1].max) * 100}%;`;
