                ...
                <form action="{{route('index')}}" method="GET">
                    ...
                    <div class="home-filter-box">
                            ...
                            <div class="filter-categories category-hight-fix">
                                ...
                                @foreach (getParentCategory() as $key => $category)
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="{{$category->id}}" id="category-check-{{$key}}" name="Category[]"
                                        @if (in_array($category->id, request()->input('Category', []))) checked
                                            @endif>
                                        <label class="form-check-label" for="category-check1">{{$category->name}}</label>
                                    </div>  
                                @endforeach
                            </div>
                        </div>
                        <div class="home-filter-inner">
                            ...
                            <div class="filter-categories category-hight-fix">
                                @foreach (getBrands() as $key=> $brand)
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="{{$brand->id}}" id="category-check-{{$key}}" name="Brand[]"
                                        @if (in_array($brand->id, request()->input('Brand', []))) checked
                                            @endif>
                                        <label class="form-check-label" for="category-check-{{$key}}">{{$brand->name}}</label>
                                    </div> 
                                @endforeach
                            </div>
                        </div>
                                ...
                                <div class="product-size-filter">
                                    @foreach (getAllsizes() as $key=> $size)
                                        <label for="size-filter-{{$key}}" class="size-filter">
                                            {{$size->name}}
                                            <input type="radio" value="{{$size->name}}" id="size-filter-{{$key}}" name="Size"
                                            @if ($size->name == request()->input('Size')) checked @endif>
                                        </label>   
                                    @endforeach
                                </div>
                            </div>
                        ...
                        <div class="home-filter-inner">
                            ...
                            <div class="form-group">
                                <div class="formfield">
                                    <input type="text" name="filter_date" id=""
