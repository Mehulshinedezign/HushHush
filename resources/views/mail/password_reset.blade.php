                                                        ...
                                                        <table cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td valign="top" width="80%"
                                                                    ...
                                                                    <h4
                                                                        style="font-size: 27px; color: #323232 !important;text-align:left;font-style: normal;font-weight: bold;letter-spacing: -1px;padding-top: 5px;">
                                                                        Hello,</h4>
                                                                    <p
                                                    ...
                                                    <td>
                                                        <table cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td width="10%" style="width: 10%;"></td>
                                                                <td width="80%"
                                                                    style="padding-top:15px;font-size:16px;line-height:26px;color:#606060;width:80%">
                                                                    <a href="{{ $link }}"
                                                                        style="font-family: 'Inter', sans-serif;background:#e8e5de;border-radius:4px;padding:8px 35px;color:#1B1B1B;font-size:17px;display:inherit;line-height:30px;text-decoration:none;font-weight: 600;">Reset
                                                                        Password
                                                                    </a>
                                                                </td>
                                                                <td width="10%" style="width: 10%;"></td>
                                                    ...
                                                    <td>
                                                        <table cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td width="10%" style="width: 10%;"></td>
                                                                {{-- <td width="80%"
                                                                    style="display: block;font-weight: 700; color:#323232;font-family: 'Inter', sans-serif;text-align:left;font-size: 16px;padding-top:15px;line-height:26px;width:80%">
                                                                    Regards</td> --}}
                                                                <td width="10%" style="width: 10%;"></td>
                                                            </tr>
                                                            <tr>
