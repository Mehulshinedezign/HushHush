                                            ...
                                            <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td valign="top"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        This verification otp will expire in 15
                                                                        minutes.</p>
                                                                </td>
                                                                <td style="width: 10%;"></td>
                                                            </tr>
                                                ...
                                                <tr>
                                                    <td colspan="3" align="center" style="padding-top: 15px;">
                                                        <a 
                                                            style="font-family: 'Inter', sans-serif;background:#e8e5de;border-radius:4px;padding:8px 35px;color:#1B1B1B;font-size:17px;display:inherit;line-height:30px;text-decoration:none;font-weight: 600;">{{ $otp }}
