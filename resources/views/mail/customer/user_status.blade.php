                                            ...
                                            <tbody>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td valign="top"
                                                                    ...
                                                                    <strong
                                                                        style="box-sizing: border-box;            sans-serif;; position: relative;">Thank
                                                                        You!</strong>
                                                                </td>
                                                                <td style="width: 10%;"></td>
                                                            </tr>
                                                ...
                                                <tr>
                                                    <td colspan="3" align="center" style="padding-top: 15px;">
                                                        {{-- <a href="{{ route('verify-email', [$user->id, $user->email_verification_token]) }}" style="font-family:Poppins, Arial, sans-serif;background:#e8e5de;border-radius:4px;padding:8px 35px;color:#fff;font-size:17px;display:inherit;line-height:30px;text-decoration:none;font-weight: 600;">Verify Email Now
                                                        </a> --}}
                                                    </td>
                                                </tr>
                                                <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td width="84%" align="center" valign="top"
                                            ...
                                            <span class="separate"
                                                style="display: block; border-top: unset; margin: 15px auto;"></span>

                                            <div style="padding: 5px 0;">
                                                {{-- <a href="{{ route('faq') }}" style="font-size: 12px;line-height: 24px;color: #606060; display: inline-block; text-decoration: none;margin-right: 10px;          ">Help & Support</a>
												<a href="{{ route('termsconditions') }}" style="font-size: 12px;line-height: 24px;color: #606060; display: inline-block; text-decoration: none;margin-right: 10px;          ">Terms and conditions</a>
												<a href="{{ route('policies') }}" style="font-size: 12px;line-height: 24px;color: #606060; display: inline-block; text-decoration: none;margin-right: 10px;          ">Privacy policies</a> --}}
