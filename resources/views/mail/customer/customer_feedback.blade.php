                                                        ...
                                                        <table cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td valign="top"
                                                                    ...
                                                                    <h4
                                                                        style="font-size: 27px; color: #1B1B1B;text-align: center;font-style: normal;font-weight: bold;letter-spacing: -1px;padding-top: 5px;       ">
                                                                        Hello, {{ $user->name }}
                                                                    </h4>
                                                                    <p
                                                                    ...
                                                                    {{-- <strong
                                                                        style="box-sizing: border-box;position: relative;font-family: 'Inter';font-weight: 400;color: #151515;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td valign="top"
                                                        ...
                                                        <div class="content-holder" style="text-align: left;">
                                                            {{-- <h4
                                                                style="font-size: 18px;color: #000;font-style: normal;font-weight: 700;font-family: 'Inter';">
                                                                <a href="{{ route('orders') }}">Leave a rating and
                                                                    review here</a>

                                                            </h4> --}}
                                                            {{-- <ul
                                                                style="list-style: number;color: #000;padding-left: 20px;font-family: 'Inter';font-style: normal;margin-bottom: 30px">
                                                            ...
                                                            <ul
                                                                style="list-style: number;color: #000;padding-left: 20px;font-family: 'Inter';font-style: normal;margin-bottom: 0px">
                                                            ...
                                                            {{-- <p
                                                                style="font-style: normal;color: #1B1B1B;font-size: 15px;       margin-bottom:5px;">
                                                                With love, --}}
                                                            {{-- <a href="mailto:team@thechere.com"
                                                                    style="color: #767676;       ">team@thechere.com</a>.
                                                            </p> --}}
                                                        ...
                                                        ">Start
                                                            ...
                                                            {{-- <p
                                                                style="font-style: normal;color: #1B1B1B;font-size: 15px;       margin: 0 0 3px">
                                                                #CheretheLove</p> --}}
                                                            {{-- <p
