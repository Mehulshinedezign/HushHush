                                                            ...
                                                            <tr>
                                                                ...
                                                                <td valign="top"
                                                                    ...
                                                                    <strong
                                                                        ...
                                                                        This email is to confirm that your rental return
                                                                        has been registered with the owner.

                                                                    </strong>
                                                                    <p
                                                                        style="box-sizing: border-box; position: relative; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; margin-top: 0; font-size: 16px;color: #1B1B1B; line-height: 22px;text-align:center;         ">
                                                                        If you purchased a security deposit, we will be
                                                                        returning it to you shortly.</p>
                                                                </td>
                                                                <td style="width: 10%;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td valign="top"
                                                        ...
                                                        <div class="content-holder" style="text-align: left;">
                                                            ...
                                                            {{-- <p
                                                                style="font-style: normal;color: #000;font-size: 15px;         margin-bottom:5px;">
                                                                With love,
