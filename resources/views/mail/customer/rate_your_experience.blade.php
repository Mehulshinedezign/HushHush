                                                            ...
                                                            <tr>
                                                                ...
                                                                <td valign="top"
                                                                    ...
                                                                    <strong
                                                                        ...
                                                                        Care to nudora your experience?
                                                                    </strong>
                                                                </td>
                                                                <td style="width: 10%;"></td>
                                                            </tr>
                                                    ...
                                                    <td valign="top"
                                                        ...
                                                        <div class="content-holder" style="text-align: left;">
                                                            <h4
                                                                ...
                                                                <a href="{{ route('retailercustomer') }}"
                                                                    data-bs-toggle="modal"
                                                                    data-bs-target="#completed-note"
                                                                    style="color: #000">Leave a rating and
                                                                    review here</a>
                                                        ...
                                                        ">Start
                                                            ...
                                                            {{-- <p
                                                                ...
                                                                #CheretheLove</p> --}}
                                                            {{-- <p
                                                                style="font-style: normal;color: #525252;font-size: 15px;font-family: 'Inter';margin: 0 0 3px;font-weight: 600;">
                                                                Annika</p>
                                                            <p
                                                                style="font-style: normal;color: #525252;font-size: 15px;font-family: 'Inter';margin: 0 0 3px;font-weight: 600;">
                                                                Founder & CEO, Chere</p> --}}
                                        ...
                                        <td width="84%" align="center" valign="top"
                                            ...
                                            <div style="padding: 5px 0;">
                                                <a href="{{ route('view', ['slug' => 'faq']) }}"
                                                    style="font-size: 12px;line-height: 24px;color: #606060;display: inline-block;text-decoration: none;margin-right: 10px;        ">FAQ</a>|
