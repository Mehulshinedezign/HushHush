        ...
        <tr>
            <td style="padding: 0px 0 0;">
                <table bgcolor="#ffffff" class="m-width" width="740px" cellpadding="0" cellspacing="0"
                    style="max-width:750px; background-color: #fff; border-collapse:collapse; width: 740px;      font-weight:normal;font-size:14px;line-height:17pt;color:#444444;margin:0 auto;">
                    <tr>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td valign="top"
                                                                    ...
                                                                    <p
                                                                        style="box-sizing: border-box; position: relative; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; margin-top: 0;margin-bottom:2px; font-size: 16px;      color:#1B1B1B; line-height: 24px;text-align:center;">
                                                                        We hope you enjoyed your experiencing chering
                                                                        {{ $product['name'] }} with
                                                                        {{ $product['retailer']['name'] }}.
                                                                    </p>
                                                                    <strong
                                                                        style="box-sizing: border-box;position: relative;      font-weight: 400;color: #1B1B1B;">
                                                                        Care to nuodra your experience?
                                                                    </strong>
                                                                </td>
                                                                <td style="width: 10%;"></td>
                                                            </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td valign="top"
                                                        ...
                                                        <div class="content-holder" style="text-align: center;">
                                                            <h4
                                                                style="font-size: 18px;color: #1B1B1B;font-style: normal;font-weight: 700;      text-align:center;margin-bottom:25px;">
                                                                <a href="{{ route('orders') }}" data-bs-toggle="modal"
                                                                    data-bs-target="#completed-note"
                                                                    style="color: #1B1B1B;text-align:center;">Leave a
                                                                    rating and
                                                                    review here</a>

                                                            </h4>
                                                            {{-- <ul
                                                                style="list-style: number;color: #1B1B1B;padding-left: 20px;      font-style: normal;margin-bottom: 30px">
                                                            ...
                                                            {{-- <h4
                                                                style="font-size: 18px;color: #1B1B1B;font-style: normal;font-weight: 700;      ">
                                                                And here are a few tips to help get you started:</h4>
                                                            <ul
                                                                style="list-style: number;color: #1B1B1B;padding-left: 20px;      font-style: normal;margin-bottom: 0px">
                                                            ...
                                                            {{-- <p
                                                                style="font-style: normal;color: #1B1B1B;font-size: 16px;      margin-bottom:5px;">
                                                                With love,
                                                                <a href="mailto:team@thechere.com"
                                                                    style="color: #767676;      ">team@thechere.com</a>.
                                                            </p> --}}
                                                            {{-- <p style="text-align: center;margin: 20px auto 50px;"><a
                                                                    href="{{ route('verify-email', [$user->id, $user->email_verification_token]) }}"
                                                        ...
                                                        ">Start
                                                            ...
                                                            {{-- <p
                                                                style="font-style: normal;color: #1B1B1B;font-size: 16px;      margin: 0 0 3px">
                                                                #CheretheLove</p> --}}
                                                            {{-- <p
                                                                style="font-style: normal;color: #525252;font-size: 16px;      margin: 0 0 3px;font-weight: 600;">
                                                                Annika</p>
                                                            <p
                                                                style="font-style: normal;color: #525252;font-size: 16px;      margin: 0 0 3px;font-weight: 600;">
                                                                Founder & CEO, Chere</p> --}}
                                        ...
                                        <td width="84%" align="center" valign="top"
                                            ...
                                            <div style="padding: 5px 0;">
                                                ...
                                                <a href="{{ route('view', ['slug' => 'privacy-policy']) }}"
                                                    style="font-size: 12px;line-height: 24px;color: #606060; display: inline-block; text-decoration: none;margin-right: 10px;      ">Privacy
                                                    Policy</a>
                                            </div>
