                                        ...
                                        <td>
                                            <label class="custom-switch">
                                                <input type="checkbox" class="custom-switch-input"
                                                    @if ($product->product->status == '1') checked="checked" @endif
                                                    onchange="toggleStatus(this, 'Product', '{{ jsencode_userdata($product->product_id) }}');">
                                                <span class="custom-switch-indicator"></span>
                                            </label>
                                        </td>
                                        <td>
                                            <a class="btn btn-primary" href="{{ route('admin.view_product', $product->product_id) }}" title="View">
                                                <i class="fa fa-eye"></i>
                                            </a>
                                            <a class="btn btn-danger delete-product" href="{{ route('admin.deleteproduct', $product->product_id) }}" title="Delete">
