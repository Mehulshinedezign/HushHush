                ...
                <div class="profile-view-outer">
                    <div class="profile-header">
                        <div class="profile-big-image">
                            ...
                            <img src="{{ $user->profile_pic_url }}" alt="user-img" class="img-fluid">
                            @else
                            <img src="{{ asset('img/avatar-small.png') }}" alt="user-img" class="img-fluid">
                            @endif
                        </div>
                    ...
                    <div class="profile-view-body">
                        <ul class="listing-row ">
                            ...
                            <li class="list-col">
                                ...
                                <span class="">{{ $user->address1 ?? 'N/A' }} @if(isset($user->address2)) , {{ $user->address2 }} @endif</span>
                            </li>
                            <li class="list-col">
                                <span class="list-item">{{ __('user.country') }}:</span>
                                <span class="">{{ @$user->country->name ?? 'N/A' }} </span>
                            </li>
                            <li class="list-col">
                                <span class="list-item">{{ __('user.state') }}:</span>
                                <span class="">{{ @$user->state->name ?? 'N/A' }}</span>
                            </li>
                            <li class="list-col">
                                <span class="list-item">{{ __('user.city') }}:</span>
                                <span class="">{{ @$user->city->name ?? 'N/A' }}</span>
                            </li>
                            <li class="list-col">
                                <span class="list-item">{{ __('user.zip') }}:</span>
                                <span class="">{{ $user->postcode ?? 'N/A' }}</span>
                            </li>
                            <li class="list-col">
                            ...
                            <li class="list-col">
                                ...
                                <span class="">
                                <a href="{{ route('admin.downloadproof', [$user->id]) }}" target="_blank">
                                Download Proof
