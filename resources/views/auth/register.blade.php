...
<form class="form-inline" method="POST" action="{{ route('register') }}" id="register">
    ...
    <div class="form-group">
        ...
        <div class="formfield">
            <input id="username" type="text" class="form-control form-class @error('username') is-invalid @enderror" name="username" value="{{ old('username') }}" autofocus autocomplete="off" placeholder="{{ __('Username') }}">
            <span class="icon">
    ...
    <div class="form-group">
        ...
        <div class="formfield">
            <input id="name" type="text" class="form-control form-class @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" autocomplete="name" placeholder="{{ __('Full Name') }}">
            <span class="icon">
                <i class="fa-solid fa-user"></i>
            </span>
        </div>
    ...
    <div class="form-group">
        ...
        <div class="formfield">
            <input id="email" type="email" class="form-control form-class @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" autocomplete="email" placeholder="{{ __('Email') }}">
            <span class="icon">
    ...
    <div class="form-group">
        ...
        <div class="formfield">
            <input id="phone_number" type="text" class="form-control form-class @error('phone_number') is-invalid @enderror" name="phone_number" value="{{ old('phone_number') }}" autocomplete="off" placeholder="{{ __('Phone Number') }}">
            <span class="icon">
    ...
    <div class="form-group">
        ...
        <div class="formfield">
            <input id="password_confirmation" type="password" class="form-control form-class @error('password') is-invalid @enderror" name="password" placeholder="{{ __('Password') }}">
    ...
    <div class="form-group">
        ...
        <div class="formfield">
            <input id="password-confirm" type="password" class="form-control form-class" name="password_confirmation" autocomplete="new-password" placeholder="{{ __('Confirm Password') }}">
            <span class="icon toggle-password">
                <i class="fas fa-eye"></i>
            </span>
        </div>
    ...
    <div class="form-group">
        ...
        <div class="formfield">
            <input id="zipcode" type="text" class="form-control form-class @error('zipcode') is-invalid @enderror" name="zipcode" autocomplete="off" value="{{ old('zipcode') }}" placeholder="{{ __('Zip Code') }}">
            @error('zipcode')
            <span class="invalid-feedback" role="alert">
                {{ $message }}
            </span>
    ...
    <div class="form-group">
        ...
        <div class="formfield">
            <input type="text" class="form-control form-class @error('is_captcha') is-invalid @enderror d-none" name="is_captcha" autocomplete="off" value="">
            @error('is_captcha')
            <span class="invalid-feedback" role="alert">
                {{ $message }}
            </span>
    ...
    <button type="submit" onclick="setCaptchaToken(`{{ env('GOOGLE_RECAPTCHA_KEY') }}`)" class="primary-btn width-full">{{ __('Submit') }}</button>
    ...
    <div class="form-setup login-form">
        ...
        <form class="form-inline" method="POST" action="{{ route('register') }}" id="register" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="formfield">
                    <input type="text" class="form-control form-class @error('name') is-invalid @enderror" name="name" id="name" placeholder="{{ __('Full Name') }}">
...
<div class="form-group">
    <div class="formfield">
        <input id="phone_number" type="text" class="form-control form-class @error('phone_number.main') is-invalid @enderror" name="phone_number[main]" value="{{ old('phone_number.main') }}" autocomplete="off" placeholder="{{ __('Phone Number') }}">
        <span class="form-icon extra-icon">
            <i class="fa-solid fa-phone"></i>
        </span>
    </div>
...
<div class="form-group">
    ...
    <div class="formfield upload-id-field">
        <input type="file" class="form-control form-class @error('gov_id') is-invalid @enderror" name="gov_id" placeholder="Enter goverment id">
...
<div class="form-group">
    ...
    <div class="formfield">
        <input type="password" class="form-control form-class @error('password') is-invalid @enderror" id="password_confirmation" name="password" placeholder="{{ __('Password') }}">
        <span class="form-icon extra-icon">
...
<div class="form-group">
    ...
    <div class="formfield">
        <input type="password" class="form-control form-class" id="password-confirm" name="password_confirmation" autocomplete="new-password" placeholder="{{ __('Confirm Password') }}">
        <span class="form-icon extra-icon">
            <i class="fa-solid fa-lock togglePassword"></i>
        </span>
    </div>
