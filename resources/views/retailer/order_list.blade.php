    ...
    <div class="containner">
        <div class="right-content innerpages">
            <div class="d-flex justify-content-between align-items-center">
                <h2 class="heading_dash">Booking Requests</h2>
                <div class="right_field brfield">
                    <div class="formfield">
                        <input type="text" class="form-control" name="text" placeholder="Select Date">
                        <span class="icon">
            ...
            <!--product tabing-->
            <div class="cardtab booking_req">
                <nav>
                    <div class="nav nav-tabs mb-3" id="nav-tab" role="tablist">
                        <button class="nav-link active" id="active-home-tab" data-bs-toggle="tab"
                            data-bs-target="#active-home" type="button" role="tab" aria-controls="active-home"
                            aria-selected="true"><i class="fa-solid fa-circle"></i> Active</button>
                        <button class="nav-link" id="completed-home-tab" data-bs-toggle="tab"
                            data-bs-target="#completed-home" type="button" role="tab" aria-controls="completed-home"
                            aria-selected="false"><i class="fa-solid fa-circle"></i> Completed</button>
                        <button class="nav-link" id="canceled-home-tab" data-bs-toggle="tab" data-bs-target="#canceled-home"
                            type="button" role="tab" aria-controls="canceled-home" aria-selected="false"><i
                                class="fa-solid fa-circle"></i> Cancelled</button>
                    </div>
                </nav>
                <div class="tab-content" id="nav-tabContent">
                    <!--Active Tab start-->
                    <div class="tab-pane fade active show" id="active-home" role="tabpanel"
                        aria-labelledby="active-home-tab">
                        @include('retailer.active-orders')
                    </div>
                    <!--Active Tab end-->
                    <!--Completed Tab start-->
                    <div class="tab-pane fade" id="completed-home" role="tabpanel" aria-labelledby="completed-home-tab">
                        @include('retailer.complete-orders')
                    </div>
                    <!--Completed Tab end-->
                    <div class="tab-pane fade" id="canceled-home" role="tabpanel" aria-labelledby="canceled-home-tab">
        ...
        <div class="container">
            ...
            <div class="order-history-tab">
                <div class="history-tab-select-option mb-2 pb-2">
                    ...
                    <form action="{{ route('retailercustomer') }}" method="post">
                        {{-- <div class="formfield"> --}}
                        @csrf
                        <div class="d-flex">
                            <div class="formfield">
                                <input type="text" readonly class="form-control reservation_date" name="date"
                                    placeholder="Rental Period" onfocus="initDateRangePicker(this)">
                                <span class="icon">
