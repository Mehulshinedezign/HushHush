                                        ...
                                        <div class="edit-delete-address-btn">
                                            ...
                                            <a href="javascript:void(0)" class="delete-address"
                                                ...
                                                <svg fill="#000000" width="20px" height="20px" viewBox="0 0 24 24"
                                                    id="delete" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div class="row g-3">
                                <div class="col-md-12">
                                    <label for="autocomplete" class="form-label">Enter
                                        your address*</label>
                                    <input id="autocomplete" name ="complete_address"
                                        placeholder="Start typing your address" class="form-control" type="text">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input id="route" name="address2" class="form-control"
                                        placeholder="Street name" />
                                </div>
                                <div class="col-lg-6">
                                    <label for="locality">City*</label>
                                    <input id="locality" name="city" class="form-control" placeholder="City"
                                        readonly />
                                </div>
                                <div class="col-lg-6">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input id="postal_code" name="zipcode" class="form-control"
